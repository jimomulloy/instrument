...
public class InstrumentController {
	...
	@GetMapping(path = "/download/{id}", produces = "application/zip")
	public ResponseEntity<StreamingOutput> downloadFileWithGet(@PathVariable(name = "id") String id) {
		LOG.severe(">>In GET: " + id);
		...
		return ResponseEntity.ok().header("Content-Disposition", "attachment; filename=\"instrument.zip\"")
				.body(streamingOutput);
	}

	@ExceptionHandler(InstrumentException.class)
	@ResponseStatus(HttpStatus.NOT_FOUND)
	public ResponseEntity<String> handleNoSuchElementFoundException(InstrumentException exception) {
