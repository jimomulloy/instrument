...
public interface AWSLambda {
    ...
    static Function createFunction(Construct thiz,String functionName,String functionHandler, Map<String,String> configuration, int memory, int timeout) {
        return Function.Builder.create(thiz, functionName)
