...
public class QuiFFT {
	...
	/**
	 * Set whether the amplitudes of each frequency bin should be scaled
	 * logarithmically (decibels) instead of linearly
	 * 
	 * @param useDecibelScale true if amplitudes should be dB scale, false for
	 *                        linear scale
	 ...
	 * 
	 * @return an FFT result containing metadata of this FFT and an array of all
	 *         {@link FFTFrame}s computed
