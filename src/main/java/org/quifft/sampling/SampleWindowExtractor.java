...
/**
 * Applies zero-padding and smoothing functions to extract sample windows from a
 * longer waveform
 * 
...
public class SampleWindowExtractor {
	...
	/**
	 * Constructs a SampleWindowExtractor to take windows from an input signal for
	 * use in FFTs
	 * 
	 * @param wave           full-length waveform of original audio file
	 * @param isStereo       true if waveform is stereo, false if mono
	 * @param windowSize     size of window as defined by FFT parameters (excludes
	 *                       zero-padding)
	...
	/**
	 * Applies zero-padding and the selected smoothing function to a given window;
	 * used with FFTStream
	 * 
