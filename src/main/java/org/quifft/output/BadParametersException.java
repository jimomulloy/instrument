...
/**
 * Raised when {@link FFTParameters} set through QuiFFT method chaining are
 * illogical, invalid, or otherwise incorrect
 * <p>
 * This exception will be raised in the following cases:
 * </p>
 * <ul>
 * <li>{@code windowSize} is less than or equal to 0</li>
 * <li>{@code numPoints} is not set and {@code windowSize} is not a power of
 * 2</li>
 ...
 * <li>{@code useDecibelScale} is set to false and {@code isNormalzed} is set to
 * true when using an {@link FFTStream}</li>
 * </ul>
 * 
 * @see FFTParameters
 */
public class BadParametersException extends RuntimeException {
	...
	/**
	 * Constructs a new {@link BadParametersException} with an explanation of which
