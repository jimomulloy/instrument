...
/**
 * Factory to produce an appropriate subclass of {@link AudioReader} depending
 * on whether input file is MP3 or WAV/AIFF
 */
public class AudioReaderFactory {

	/**
	 * Produces a {@link PCMReader} if given file is WAV or AIFF, {@link MP3Reader}
	 * if MP3, throws exception otherwise
	 * 
	 * @param audioFile audio file to read
	 * @return the appropriate subclass of {@link AudioReader} based on file type
	 * @throws IOException                   if an I/O exception arises during
	 *                                       creation of audio reader
	...
	public static AudioReader audioReaderFor(File audioFile) throws IOException, UnsupportedAudioFileException {
		...
		default:
			String msg = String.format(
					"Cannot read file type %s; " + "please provide a .wav, .aiff, or .mp3 file instead.",
					fileExtension);
	 ...
	 * @throws UnsupportedAudioFileException if file name doesn't include an
	 *                                       extension
	 */
