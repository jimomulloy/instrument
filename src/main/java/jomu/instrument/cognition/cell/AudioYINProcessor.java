...
public class AudioYINProcessor extends ProcessorCommon {
	...
	public void accept(List<NuMessage> messages) throws Exception {
		...
		LOG.info(">>AudioYINProcessor accept: " + sequence + ", streamId: " + streamId);
		...
		ToneMap toneMap = workspace.getAtlas().getToneMap(buildToneMapKey(CellTypes.AUDIO_YIN, streamId));
