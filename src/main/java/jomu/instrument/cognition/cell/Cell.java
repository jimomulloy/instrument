...
public abstract class Cell {
	...
	public static enum CellTypes {
		AUDIO_CQ, AUDIO_CQ_ORIGIN, AUDIO_CQ_MICRO_TONE, AUDIO_TUNER_PEAKS, AUDIO_BEAT, AUDIO_ONSET, AUDIO_INTEGRATE,
		AUDIO_NOTATE, AUDIO_PITCH, AUDIO_YIN, AUDIO_HPS, AUDIO_SPECTRAL_PEAKS, AUDIO_SINK, AUDIO_PRE_CHROMA,
		AUDIO_POST_CHROMA, JUNCTION, PASS_THROUGH, SINK, SOURCE
