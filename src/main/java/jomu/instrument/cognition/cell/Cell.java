...
public abstract class Cell {
	...
	public static enum CellTypes {
		AUDIO_CQ, AUDIO_TUNER_PEAKS, AUDIO_BEAT, AUDIO_ONSET, AUDIO_INTEGRATE, AUDIO_NOTATE, AUDIO_PITCH,
		AUDIO_LOW_PITCH, AUDIO_HPS, AUDIO_SPECTRAL_PEAKS, AUDIO_SINK, AUDIO_PRE_CHROMA, AUDIO_POST_CHROMA, JUNCTION,
