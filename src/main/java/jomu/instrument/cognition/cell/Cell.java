...
public abstract class Cell {
	...
	public static enum CellTypes {
		AUDIO_CQ, AUDIO_ONSET, AUDIO_BEAT, AUDIO_INTEGRATE, AUDIO_NOTATE, AUDIO_PITCH, AUDIO_SPECTRUM,
		AUDIO_SPECTRAL_PEAKS, AUDIO_SINK, AUDIO_CHROMA, JUNCTION, PASS_THROUGH, SINK, SOURCE
