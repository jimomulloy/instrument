...
/**
 * This class handles the User Interface functions for the central
 * ToneMap control class.
 * This includes inner clases to handle display and control of a
 * Scrollable View pane that displays the contents of the ToneMap
 * Matrix objects.
 *
...
public class ToneMapPanel extends JPanel implements ProgressListener,
			...
			public void actionPerformed(ActionEvent evt) {
				...
				worker = new SwingWorker() {
					public Object construct() {
						if (toneMap.loadAudio()) return this;
						else return null;
					}
	...
	class ProcessBAction implements ActionListener {
			...
			public void actionPerformed(ActionEvent evt) {
				...
				worker = new SwingWorker() {
					public Object construct() {
						if (toneMap.process()) return this;
						else return null;
					}
