...
public class ToneMapFrame implements ToneMapConstants {
	...
	protected void buildContent() {
		...
		if (toneMapPanel != null) tabPane.addTab("Map", toneMapPanel);
	 	if (audioPanel != null) tabPane.addTab("Audio", audioPanel);
		if (midiPanel != null) tabPane.addTab("MIDI", midiPanel);
		if (tunerPanel != null) tabPane.addTab("Tuner", tunerPanel);
