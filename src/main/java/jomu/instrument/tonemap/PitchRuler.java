...
/**
 * This class is a GUI component that acts as a Ruler displaying the 
 * vertical Pitch coordinate values for the Tone Map Scrollable View 
 * Pane on the ToneMapPanel UI. 
 *
