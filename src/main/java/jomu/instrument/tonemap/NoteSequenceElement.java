...
/**
  * This class defines the fields of the data elements contained within 
  * the NoteSequence object which represent Note data used for creating MIDI 
  * Messages for writing to a MIDI Sequence 
  *
