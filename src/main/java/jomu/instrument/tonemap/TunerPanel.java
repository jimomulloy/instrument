...
public class TunerPanel extends JPanel implements ToneMapConstants {
	...
	class NoteControl extends JPanel {
		...
		public NoteControl() {
			...
			add(noteHighSlider);
			noteSustainSlider = new TmSlider(JSlider.HORIZONTAL, 0, 1000, 
									INIT_NOTE_SUSTAIN,
			...
			noteMaxDurationSlider = new TmSlider(JSlider.HORIZONTAL, 100, 10000, 
	...
	class FormantControl extends JPanel {
		...
		public FormantControl() {
			...
			formantLowS = new TmSlider(JSlider.HORIZONTAL, 0, 100,
						0, "Formant low",new FilterSliderListener());
			formantMiddleS = new TmSlider(JSlider.HORIZONTAL, 0, 100,
						50, "Formant middle",new FilterSliderListener());
			formantHighS = new TmSlider(JSlider.HORIZONTAL, 0, 100,
						100, "Formant high",new FilterSliderListener());
			formantFreqS = new TmSlider(JSlider.HORIZONTAL, 0, 100,
						0, "Formant Factor",new FilterSliderListener());
	...
	class FilterControl extends JPanel {
		...
		public FilterControl() {
			...
			normalizeS = new TmSlider(JSlider.HORIZONTAL, 1, 1000,
						100, "Normalisation",new FilterSliderListener());
	...
	class NormalizeControl extends JPanel {
		...
		public NormalizeControl() {
			...
			n1S = new TmSlider(JSlider.HORIZONTAL, 1, 100,
						100, "N1",new NormalizeSListener());
			n2S = new TmSlider(JSlider.HORIZONTAL, 1, 100,
						100, "N2",new NormalizeSListener());
			n3S = new TmSlider(JSlider.HORIZONTAL, 1, 100,
						100, "N3",new NormalizeSListener());
			n4S = new TmSlider(JSlider.HORIZONTAL, 1, 100,
						100, "N4",new NormalizeSListener());
			n5S = new TmSlider(JSlider.HORIZONTAL, 1, 100,
						100, "N5",new NormalizeSListener());
			n6S = new TmSlider(JSlider.HORIZONTAL, 1, 100,
						100, "N6",new NormalizeSListener());
	...
	public JCheckBox harmonicCB, formantCB, droneCB, undertoneCB, peakCB, spikeCB, normalizeCB,
			n1CB, n2CB, harmonicACB, formantACB; 
