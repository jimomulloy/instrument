...
/**
  * This is a class that encapsulates parameters associated with 
  * ToneMap Pitch base coordinate range and settings and provides 
  * various methods for conversion betwen pitch values as MIDI 
