...
public final class Manager {
	...
	if (sources.size() != 0) {
	    Enumeration enum1 = sources.elements();
	    while (enum1.hasMoreElements()) {
		DataSource ds = (DataSource)enum1.nextElement();
		ds.disconnect();
	    }
	}
...
// 	}
	...
	System.out.println("DataSource created: " + source + "\n");
...
// 	}
	...
	System.out.println("  using DataSource: " + source + "\n");
...
// 	}
	...
	System.out.println("Processor created: " + newProcessor);
	System.out.println("  using DataSource: " + source + "\n");
	...
	System.out.println("DataSink created: " + dataSink);
