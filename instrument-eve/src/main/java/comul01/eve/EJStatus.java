...
/**
  * This class contains an array of StatusInfo objects that define
  * Status and Error information that is accessed by the ToneMapFrame 
...
public class EJStatus implements EJConstants {
...
/**
 * FrameStatus constructor comment.
 */
	public EJStatus() {
		super();
	}
