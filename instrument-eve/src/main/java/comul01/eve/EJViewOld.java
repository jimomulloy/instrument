...
public class EJViewOld extends JPanel implements ControllerListener, DataSinkListener, ProgressListener {
    ...
    String outputFile = "file:/C:/java/jmf/minime/test.mov";
    Image texture;
    ...
    public EJViewOld(EJMain ejMain) {
	...
	try {
		...
		System.out.println("Test minime 2");
