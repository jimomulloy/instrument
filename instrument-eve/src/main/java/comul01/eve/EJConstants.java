...
/**
  * This interface defines a set of Constants used across the whole 
  * ToneMap program and is implementeded by most of the classes.
  *
 ...
 public interface EJConstants {
	...
	public static final int FILM_MODE_AVI=0;
	public static final int FILM_MODE_MOV=1;	
	...
	public final static int INIT_PITCH_LOW=48;
	public final static int INIT_PITCH_HIGH=108;
	...
	public static final int INIT_HIGH_THRESHHOLD = 0;
	...
	public static final int INIT_NOTE_HIGH=0;
