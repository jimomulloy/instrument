...
public class WaterRipple extends Applet implements Runnable, MouseListener, MouseMotionListener
{
	/** Filename of background image. */
	private final String BACKGROUND_IMAGE_FILENAME = "background.jpg";
	...
	private float DRIP_CHANCE = 0.2f;
	...
	public void updateState()
	{
		...
		switch (state)
		{
			...
			case STATE_DRIP:
				...
				if (Math.random() < DRIP_CHANCE || frame%4==0)
				{
