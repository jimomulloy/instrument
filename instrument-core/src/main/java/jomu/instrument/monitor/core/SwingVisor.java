...
@ApplicationScoped
@Default
public class SwingVisor implements Visor, AudioFeatureFrameObserver {

	private static final Logger LOG = Logger.getLogger(SwingVisor.class.getName());
	...
	@Override
	public void startUp() {
		LOG.warning(">>Using SwingCoreVisor");
