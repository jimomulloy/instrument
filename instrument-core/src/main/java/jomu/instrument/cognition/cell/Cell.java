...
public abstract class Cell {
	...
	public static enum CellTypes {
		...
		AUDIO_INTEGRATE, AUDIO_NOTATE, AUDIO_PITCH, AUDIO_YIN, AUDIO_SACF, AUDIO_MFCC, AUDIO_CEPSTRUM, AUDIO_SYNTHESIS,
		AUDIO_HPS, AUDIO_SPECTRAL_PEAKS, AUDIO_SINK, AUDIO_PRE_CHROMA, AUDIO_POST_CHROMA, JUNCTION, PASS_THROUGH, SINK,
		SOURCE
