...
public class AudioPhaseProcessor extends ProcessorCommon {

	private static final Logger LOG = Logger.getLogger(AudioPhaseProcessor.class.getName());

	public AudioPhaseProcessor(NuCell cell) {
		super(cell);
	}
