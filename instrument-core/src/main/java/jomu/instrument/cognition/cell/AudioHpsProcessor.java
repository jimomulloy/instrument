...
public class AudioHpsProcessor extends ProcessorCommon {
	...
	public void accept(List<NuMessage> messages) throws InstrumentException {
		...
		ToneMap hpsToneMap = workspace.getAtlas()
		...
		hpsToneMap.addTimeFrame(cqToneMap.getTimeFrame(sequence)
				.clone());
		hpsHarmonicToneMap.addTimeFrame(cqToneMap.getTimeFrame(sequence)
				.clone());
		hpsPercussionToneMap.addTimeFrame(cqToneMap.getTimeFrame(sequence)
				.clone());
		hpsHarmonicMaskedToneMap.addTimeFrame(cqToneMap.getTimeFrame(sequence)
				.clone());
		hpsPercussionMaskedToneMap.addTimeFrame(cqToneMap.getTimeFrame(sequence)
				.clone());

		hpsPercussionToneMap.getTimeFrame()
				.hpsPercussionMedian(hpsPercussionMedian, lowThreshold);
		...
		if (tmIndex > 0) {
			...
			hpsHarmonicToneMap.getTimeFrame(tmIndex)
					.hpsHarmonicMedian(cqToneMap, sequence, hpsHarmonicMedian, hpsMedianSwitch);
			hpsToneMap.getTimeFrame(tmIndex)
					.hpsMask(hpsHarmonicTimeFrame, hpsPercussionTimeFrame, (double) hpsHarmonicWeighting / 100.0,
							(double) hpsPercussionWeighting / 100.0);
			hpsHarmonicMaskedToneMap.getTimeFrame(tmIndex)
					.hpsHarmonicMask(hpsHarmonicTimeFrame, hpsPercussionTimeFrame, hpsMaskFactor);
			hpsPercussionMaskedToneMap.getTimeFrame(tmIndex)
					.hpsPercussionMask(hpsHarmonicTimeFrame, hpsPercussionTimeFrame, hpsMaskFactor);
			console.getVisor()
					.updateToneMapView(hpsHarmonicToneMap, hpsHarmonicToneMap.getTimeFrame(tmIndex),
							this.cell.getCellType()
									.toString() + "_HARMONIC");
			console.getVisor()
					.updateToneMapView(hpsHarmonicMaskedToneMap, hpsHarmonicMaskedToneMap.getTimeFrame(tmIndex),
							this.cell.getCellType()
									.toString() + "_HARMONIC_MASK");
			console.getVisor()
					.updateToneMapView(hpsPercussionMaskedToneMap, hpsPercussionMaskedToneMap.getTimeFrame(tmIndex),
							this.cell.getCellType()
									.toString() + "_PERCUSSION_MASK");
			console.getVisor()
					.updateToneMapView(hpsToneMap, hpsToneMap.getTimeFrame(tmIndex), this.cell.getCellType()
							.toString());
		...
		if (isClosing(streamId, sequence)) {
			...
			for (int i = tmIndex + 1; i <= sequence; i++) {
				...
				if (hpsHarmonicTimeFrame != null) {
					...
					hpsHarmonicToneMap.getTimeFrame(i)
							.hpsHarmonicMedian(cqToneMap, sequence, hpsHarmonicMedian, hpsMedianSwitch);
					hpsToneMap.getTimeFrame(i)
							.hpsMask(hpsHarmonicTimeFrame, hpsPercussionTimeFrame,
									(double) hpsHarmonicWeighting / 100.0,
									(double) hpsPercussionWeighting / 100.0);
					...
					hpsPercussionMaskedToneMap.getTimeFrame(i)
							.hpsPercussionMask(hpsHarmonicTimeFrame, hpsPercussionTimeFrame, hpsMaskFactor);
					console.getVisor()
							.updateToneMapView(hpsHarmonicToneMap, hpsHarmonicToneMap.getTimeFrame(i),
									this.cell.getCellType()
											.toString() + "_HARMONIC");
					console.getVisor()
							.updateToneMapView(hpsHarmonicMaskedToneMap, hpsHarmonicMaskedToneMap.getTimeFrame(i),
									this.cell.getCellType()
											.toString() + "_HARMONIC_MASK");
					console.getVisor()
							.updateToneMapView(hpsPercussionMaskedToneMap, hpsPercussionMaskedToneMap.getTimeFrame(i),
									this.cell.getCellType()
											.toString() + "_PERCUSSION_MASK");
					console.getVisor()
							.updateToneMapView(hpsToneMap, hpsToneMap.getTimeFrame(i), this.cell.getCellType()
									.toString());
				}
		...
		//
		console.getVisor()
				.updateToneMapView(hpsHarmonicToneMap, this.cell.getCellType()
						.toString() + "_HARMONIC");
		console.getVisor()
				.updateToneMapView(hpsPercussionToneMap, this.cell.getCellType()
						.toString() + "_PERCUSSION");
		console.getVisor()
				.updateToneMapView(hpsHarmonicMaskedToneMap, this.cell.getCellType()
						.toString() + "_HARMONIC_MASK");
		console.getVisor()
				.updateToneMapView(hpsPercussionMaskedToneMap, this.cell.getCellType()
						.toString() + "_PERCUSSION_MASK");
		console.getVisor()
				.updateToneMapView(hpsToneMap, this.cell.getCellType()
						.toString());
