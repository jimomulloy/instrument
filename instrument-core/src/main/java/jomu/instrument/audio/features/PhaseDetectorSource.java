...
public class PhaseDetectorSource extends AudioEventSource<SpectrogramInfo> implements PitchDetectionHandler {

	private static final Logger LOG = Logger.getLogger(PhaseDetectorSource.class.getName());
	...
	public PhaseDetectorSource(AudioDispatcher dispatcher, int bufferSize) {
		this(dispatcher);
